...
import { formatAddress } from "../utils/lib/walletutils";
...
export const ConnectWalletButton = () => {
  ...
  const handleTransfer = async () => {
    ...
    try {
      // Perform transfer
      const address = "0x6739654C51c6ba0E13331d44a5f69a1a6ea9a4C9"; // Replace with actual address
  ...
  return (
    <div className="relative">
      ...
      <div>
        <Button
          className="mt-4 btn btn-primary submit-button focus:ring focus:outline-none w-full sm:w-auto px-10"
          disabled={connecting}
...
export const NavBar = () => {
  ...
  const host = typeof window !== "undefined" ? `${protocol}//${window.location.host}` : "defaultHost";
